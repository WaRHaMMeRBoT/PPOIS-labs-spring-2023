...
class PowerUp(pygame.sprite.Sprite):
    def __init__(self, screen, center):
        ...
        self.powerup_images = {'health_point': pygame.image.load(utilities.get_image("pill_red.png")),
                               'shoot': pygame.image.load(utilities.get_image("shoot.png")),
                               'speed': pygame.image.load(utilities.get_image('bolt_gold.png')),
                               'reload': pygame.transform.scale(pygame.image.load(utilities.get_image('reload.png')),
                                                                (30, 30))}
