...
class WaveController:
    ...
    def new_wave(self, target):
        self.wave_cd = 0
        self.wave_number += 1
        wave = Wave(self.get_types(), self.screen, self.amount,
                    self.maxX, self.maxY, self.groups)
    ...
    def draw_timer(self, screen, x: int, y: int):
        ...
        pygame.gfxdraw.arc(screen, x, y, 23, -90,
                           wave_percentage - 90, (255, 255, 255))
        pygame.gfxdraw.arc(screen, x, y, 24, -90,
                           wave_percentage - 90, (255, 255, 255))
        pygame.gfxdraw.arc(screen, x, y, 25, -90,
                           wave_percentage - 90, (255, 255, 255))
