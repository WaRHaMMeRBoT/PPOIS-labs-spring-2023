...
from lr3.constants import WIDTH
from lr3.walls import Wall, CrossWall, LWall, HorizontalWall, BoardWall, RectangleWall
...
class Board:
    ...
    def __init__(self):
        ...
        self.wall = HorizontalWall(height=50, width=350, pos=(90, 850))
        self.add(self.wall)
