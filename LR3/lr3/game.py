...
from lr3.constants import red_ghost_img, blue_ghost_img, pink_ghost_img, orange_ghost_img, WIDTH, HEIGHT
from lr3.ghosts import Ghost
from lr3.pills import Pill
from lr3.player import Player
from lr3.score import Score
...
class Game:
    def __init__(self, menu: pygame_menu.Menu):
        ...
        self.ghosts.add(self.red, self.pink, self.blue, self.orange)
