...
pygame.display.set_icon(constants.stone1)
...
start_button = Button(250, 100, 400, 100, medium_font, buttonText="Normal Game", onclickFunction=lambda: start_game())
start_timeout_button = Button(250, 250, 400, 100, medium_font, buttonText="Timeout Game", onclickFunction=lambda: start_with_timeout_game(10))
...
def start_with_timeout_game(level):
    ...
    currentBoard = Board(scoreBoard)
    pygame.time.set_timer(EventType.TIMEOUT.value, 20 * 1000)
