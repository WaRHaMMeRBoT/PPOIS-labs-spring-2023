...
pygame.mixer.music.load('./music/playing.mp3')
...
def draw_misc():
    ...
    if game_over:
        ...
        file = open(r'menu/score.txt', 'r')
        line = file.readline()
        line2 = file.readline()
        file.close()
        file2 = open(r'menu/score.txt', 'w')
        file2.write(f'{score}\n{line2}')
        file2.close()
        pygame.mixer.music.stop()
        pygame.mixer.music.load('./music/end-game.mp3')
        pygame.mixer.music.play(0)
        os.chdir(r'c:/учеба/ППОИС/semestr4/Pacman/menu')
        os.system('py end_game.py')
        sys.exit()
    if game_won:
        # pygame.draw.rect(screen, 'white', [50, 200, 800, 300], 0, 10)
        # pygame.draw.rect(screen, 'dark gray', [70, 220, 760, 260], 0, 10)
