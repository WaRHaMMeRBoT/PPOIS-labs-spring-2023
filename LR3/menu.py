    ...
    if need_input:
        for event in pygame.event.get():
            if need_input and event.type == pygame.KEYDOWN:
                ...
                input_text += '_'
    if len(input_text):
        print_text(message=input_text, x=input_rect.x +
                   5, y=input_rect.y + 5, font_size=30)
    input_tick -= 1
...
def print_text(message, x, y, font_clr=(0, 0, 0), font_size=30):
...
def pause():
    ...
    while paused:
        ...
        print_text('Paused! press ENTER to continue', 110,
                   280, font_clr=(255, 255, 255), font_size=20)
