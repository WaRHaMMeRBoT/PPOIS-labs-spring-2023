...
import sys
import pygame.event
from models.GameCharacteristics import *
import random
from models.DeadPlayer import DeadPlayer
from models.Asteroids import Asteroid
...
class GameProcess:
    ...
    def help(self):
        ...
        while self.game_state == "Help":
            x = display_width / 2
            y = display_height / 8
            GameProcess.draw_text("Help", green, x, y, 100, font='cambria')
    ...
    def records(self):
        ...
        while self.game_state == "Records":
            ...
            GameProcess.draw_text("Game Best Record", green, x, y, 100)
    ...
    def game_loop(self, display_state="Menu"):
        ...
        pygame.mixer.music.load("/home/user/Downloads/Telegram Desktop/backup/u/Asteroids/sounds/background.mp3")
