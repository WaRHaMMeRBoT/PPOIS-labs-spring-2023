...
def draw_start_menu():
    ...
    start = font.render('Space - Play', True, (255, 255, 255))
    reference = font.render('I - Info', True, (255, 255, 255))
    record = font.render('R - Record', True, (255, 255, 255))
    start_button = font.render('Esc - Quit', True, (255, 255, 255))
