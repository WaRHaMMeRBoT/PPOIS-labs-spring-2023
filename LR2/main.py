...
class MyApp(App):
    ...
    def add_pet(self,  popup, add_popup: BoxLayout, instance):
        ...
        pet.birth_date = datetime.datetime.strptime(add_popup.children[5].text, '%d.%m.%y').date()
        pet.date_of_last_admission = datetime.datetime.strptime(add_popup.children[4].text, '%d.%m.%y').date()
