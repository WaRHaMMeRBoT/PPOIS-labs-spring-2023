    ...
    def close(self, obj):
        ...
        self.controller.close_dialog(
            [
                ...
                self.content_cls.ids.input_address.text,
                self.content_cls.ids.input_date_of_birth.text,
                self.content_cls.ids.input_date_of_visit.text,
                self.content_cls.ids.input_doctor_name.text,
                self.content_cls.ids.input_conclusion.text,
            ]
        )
    ...
    def close(self, obj):
        ...
        self.controller.close_dialog(
            [
                ...
                self.content_cls.ids.filter_address.text,
                self.content_cls.ids.filter_date_of_birth.text,
                self.content_cls.ids.filter_date_of_visit.text,
                self.content_cls.ids.filter_doctor_name.text,
                self.content_cls.ids.filter_conclusion.text,
            ]
        )
    ...
    def close(self, obj):
        ...
        self.controller.close_dialog(
            [
                ...
                self.content_cls.ids.delete_address.text,
                self.content_cls.ids.delete_date_of_birth.text,
                self.content_cls.ids.delete_date_of_visit.text,
                self.content_cls.ids.delete_doctor_name.text,
                self.content_cls.ids.delete_conclusion.text,
            ]
        )
