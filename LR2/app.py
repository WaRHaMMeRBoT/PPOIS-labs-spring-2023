...
class AllProductScreen(MDScreen):
    def __init__(self, **kwargs):
        ...
        data = pd.read_csv("/Users/ignat/Desktop/ППОИС/PPOIS/LR2/dataframe")
        # self.data = data
    ...
    def update_table(self):
        self.table.row_data = pd.read_csv("/Users/ignat/Desktop/ППОИС/PPOIS/LR2/dataframe").values.tolist()
...
class FindProductScreen(MDScreen):
    ...
    def update_table(self):
        self.data = pd.read_csv("/Users/ignat/Desktop/ППОИС/PPOIS/LR2/dataframe")
        self.table.row_data = pd.read_csv("/Users/ignat/Desktop/ППОИС/PPOIS/LR2/dataframe").values.tolist()
...
class AddProductScreen(MDScreen):
    ...
    def save_data(self, product_info: dict):
        df = pd.read_csv('/Users/ignat/Desktop/ППОИС/PPOIS/LR2/dataframe')
        if product_info['stock_address'] == '':
            product_info['stock_address'] = 'Нет адреса'
        tmp = pd.DataFrame([product_info], index=None)
        df = pd.concat([df, tmp])

        with open('/Users/ignat/Desktop/ППОИС/PPOIS/LR2/dataframe', 'w') as f:
