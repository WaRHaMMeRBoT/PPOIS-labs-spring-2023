...
class Filter:
    def __init__(self,controller):
        ...
        self.do_work.text = 'Число пропуском по болезни'
        self.do_work.pos_hint = {'center_x': .5, 'center_y': .5}
        self.lang_item = MDDropDownItem()
        self.lang_item.text = 'Общее число пропусков'
        ...
        self.dialog = MDDialog(
            ...
            MDTextField(
                ...
                font_size='20',
                max_text_length = 7,
                helper_text= "Поле должно содержать как минимум 1 символ",
                helper_text_mode= "on_error"
            ),
            MDTextField(
                id = 'group',
    ...
    def close(self):
        self.dialog.dismiss()
        self.lang_item.text = 'Общее число пропусков'
        self.do_work.text = 'Число пропусков по болезни'
