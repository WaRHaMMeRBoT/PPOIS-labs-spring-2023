...
class Controller:
    ...
    def add_student_in_table(self):
        ...
        def create_student_data():
            return {
                ...
                'ill_hours':data_from_add_dialog_window.ill_hours.text,
                'other_reason':data_from_add_dialog_window.other_reason.text,
                'no_reason':data_from_add_dialog_window.no_reason.text,
                'all_hours':data_from_add_dialog_window.all_hours.text,
            }
    ...
    def get_filter_data(self):            
        ...
        return {
                ...
                'ill_hours': data.ill_hours.text,
                'other_reason': data.other_reason.text,
                'no_reason': data.no_reason.text,
                'all_hours': data.all
            }
