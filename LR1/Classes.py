...
class Plant:
    def __init__(self, age=0, size=0.1, name="Wild plant", coordinates=None):
...
class Field:
    ...
    def breed(self, creature_1: Animal, creature_2: Animal):
        ...
        if creature_2 == "Owl":
            child = Owl(25, 0, [creature_1.get_coordinates()[0], creature_1.get_coordinates()[1]], gender, 0.1, "Owl",
                        child_name)
        elif creature_2 == "Wolf":
            child = Wolf(25, 0, [creature_1.get_coordinates()[0], creature_1.get_coordinates()[1]], gender, 0.20,
                         "Wolf", child_name)
        elif creature_2 == "Mouse":
            child = Mouse(25, 0, [creature_1.get_coordinates()[0], creature_1.get_coordinates()[1]], gender, 0.01,
                          "Mouse", child_name)
        elif creature_2 == "Deer":
            child = Deer(25, 0, [creature_1.get_coordinates()[0], creature_1.get_coordinates()[1]], gender, 0.25,
                         "Deer", child_name)
        else:
