...
class Animal:
    ...
    def coordinates_setter(self, coordinates: tuple):
        self.__coordinates = coordinates
...
class Deer(GrassFeeding, Animal):
    def __init__(self, satiety: int, age: int, coordinates: tuple, gender: str, body_size=1.0, specie="Deer", name=""):
...
class Bison(GrassFeeding, Animal):
    def __init__(self, satiety: int, age: int, coordinates: tuple, gender: str, body_size=2.0, specie="Bison", name=""):
        GrassFeeding.__init__(self)
        Animal.__init__(self, satiety, age, body_size, name, coordinates, gender)
        self.__specie = specie
        self.satiety_setter(satiety)
...
class Mouse(GrassFeeding, Animal):
    def __init__(self, satiety: int, age: int, coordinates: tuple, gender: str, body_size=0.1, specie="Mouse", name=""):
...
class Wolf(Predator, Animal):
    def __init__(self, satiety: int, age: int, coordinates: tuple, gender: str, body_size=0.25, specie="Wolf", name=""):
        Animal.__init__(self, satiety, age, body_size, name, coordinates, gender)
...
class Owl(Predator, Animal):
    def __init__(self,  satiety: int, age: int, coordinates: tuple, gender: str, body_size=0.25, specie="Owl", name=""):
        Animal.__init__(self, satiety, age, body_size, name, coordinates, gender)
...
class Field:
    ...
    def get_adjacent_cells(self, coordinates: tuple):
        list_of_adjacent = []
        if coordinates[1] > 0:
    ...
    def move(self, creature, where: tuple):
        creature: Animal
    ...
    def create_animal(self, creature, where: tuple):
        self.__matrix[where[0]][where[1]].add(creature)
