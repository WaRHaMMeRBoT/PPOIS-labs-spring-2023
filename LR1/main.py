...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--replenish-phone",
        help="Replenish phone from the card",
        type=int,
    )
    ...
    if args.card and args.pin and args.add:
        App.replenish_card(args.card, args.pin, args.add)

    if args.card and args.pin and args.withdraw:
        App.withdraw_money(args.card, args.pin, args.withdraw)

    if args.replenish_phone and args.from_card and args.pin and args.amount:
        App.replenish_phone(args.replenish_phone, args.from_card, args.pin, args.amount)
