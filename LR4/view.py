...
class Garden(MDApp):
    ...
    def update_data(self):
        self.root.ids.main_screen.ids.weather.text = "Weather: " + str(self.model.get_weather())
        self.root.ids.main_screen.ids.tree_kol.text = "Amount of weather: " + str(self.model.tree_kol())
        self.root.ids.main_screen.ids.money.text = "Money: " + str(self.model.money())
        self.root.ids.main_screen.ids.garden_bed_kol.text = "Amount of patches: " + str(self.model.garden_bed_kol())
        self.root.ids.main_screen.ids.day.text = "Day : " + str(self.model.day())
        self.show_data()
